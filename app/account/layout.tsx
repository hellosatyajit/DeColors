...
export default function AccountLayout({
    ...
    return (
        <section className="max-w-7xl m-auto p-5 flex flex-col md:flex-row gap-5 md:mb-20">
            <aside id="default-sidebar" className="sticky top-0 left-0 z-40 w-full md:w-64 h-min" aria-label="Sidebar">
                <div className="h-full p-2 overflow-y-auto bg-pink-50 rounded-xl">
                    <ul className="flex flex-row justify-between md:flex-col gap-2 font-normal">
                        <li>
