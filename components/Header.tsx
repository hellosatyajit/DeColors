    ...
    <nav className="w-full bg-rose-600">
      <div className="max-w-[1600px] w-full m-auto p-5 flex justify-between items-center">
        <div className="flex items-center gap-10">
          <div>
            <Link href="/" className="text-white text-2xl font-bold">De Colors Lifestyle</Link>
          </div>
        ...
        <div className="flex gap-2">
          ...
          <div className="w-10 h-10 flex justify-center items-center bg-white rounded-xl cursor-pointer relative group">
